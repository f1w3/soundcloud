...
.sc-button-small.sc-button-icon:not(.sc-button-stretch-icon), .sc-button-small.sc-button-responsive:not(.sc-button-stretch-icon) {
    background-color: transparent !important;
...
.userBadge__actions>.sc-button-follow.sc-button.sc-button-small.sc-button-responsive.sc-button-secondary {
    background-color: #000 !important;
}

.playbackSoundBadge__actions>.sc-button-like.playbackSoundBadge__like.sc-button-secondary.sc-mr-1x.sc-button.sc-button-small.sc-button-icon.sc-button-responsiv{
    border: none !important;
}

.playbackSoundBadge__showQueue>.sc-button-small.sc-button-icon:not(.sc-button-stretch-icon), .sc-button-small.sc-button-responsive:not(.sc-button-stretch-icon){
    border: none !important;
}
